...
if ($_SERVER['REQUEST_METHOD'] == "GET" ){
    ...
    if(isset($_GET['ordenacion'])){
        switch($_GET['ordenacion']){
            case "id-Asc": $_SESSION['ordenacion'] = " order by id ASC "; break;
            case "id-Desc": $_SESSION['ordenacion'] = " order by id DESC "; break;

            case "nom-Asc": $_SESSION['ordenacion'] = " order by first_name ASC "; break;
            case "nom-Desc": $_SESSION['ordenacion'] = " order by first_name DESC "; break;

            case "email-Asc": $_SESSION['ordenacion'] = " order by email ASC "; break;
            case "email-Desc": $_SESSION['ordenacion'] = " order by email DESC "; break;

            case "gen-Asc": $_SESSION['ordenacion'] = " order by gender ASC "; break;
            case "gen-Desc": $_SESSION['ordenacion'] = " order by gender DESC "; break;

            case "ip-Asc": $_SESSION['ordenacion'] = " order by ip_address ASC "; break;
            case "ip-Desc": $_SESSION['ordenacion'] = " order by ip_address DESC "; break;

            case "tel-Asc": $_SESSION['ordenacion'] = " order by telefono ASC "; break;
            case "tel-Desc": $_SESSION['ordenacion'] = " order by telefono DESC "; break;
        }
    }
} 
